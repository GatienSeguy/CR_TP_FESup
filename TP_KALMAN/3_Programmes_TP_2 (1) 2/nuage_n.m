function nuage_n(A,V,C,std_g,std_w,m_0,P_0,Q,R,k_max,N,fig);

% nuage_n(A,V,C,std_g,std_w,m_0,P_0,Q,R,k_max,N, fig);
%
% Cette fonction effectue une étude statistique pour la kième itération
% de la trajectoire du robot avec des bruits gaussiens.
%
