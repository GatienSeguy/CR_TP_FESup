%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Script automatisé pour la Manipulation 2 du TP
% MCR avec facteur d'oubli
% (Version sans Control System Toolbox)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% =========================================================================
fprintf('\n=== PARTIE 1 : MCR sans facteur d''oubli ===\n');
...
fig2 = figure('Position', [100 100 900 600], 'Visible', 'off');
subplot(2,2,1);
stairs(t, e, 'r', 'LineWidth', 1); hold on;
plot(t, s, 'b--', 'LineWidth', 1.5);
plot(t, s_b, 'b', 'LineWidth', 0.5);
...
subplot(1,2,1);
plot(t, a_true, 'r', 'LineWidth', 2); hold on;
title('Estimation de a (\lambda = 0.95)');
xlabel('Temps (s)'); ylabel('a'); grid on;

subplot(1,2,2);
plot(t, b_true, 'r', 'LineWidth', 2); hold on;
title('Estimation de b (\lambda = 0.95)');
xlabel('Temps (s)'); ylabel('b'); grid on;
